...
public class SportStat {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Game2> games = readFromFile(fileName);
        ...
        ArrayList<Game2> gamesOfATeam = new ArrayList<>();
    ...
    public static ArrayList<Game2> readFromFile(String fileName) {
        ...
        try (Scanner scan = new Scanner(Paths.get(fileName))) {
            ...
            while (scan.hasNextLine()) {
                ...
                games.add(new Game2(homeTeam, opposingTeam, homePoints, opposingPoints));
